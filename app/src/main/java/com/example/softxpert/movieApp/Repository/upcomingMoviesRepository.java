...
//this class for allMoviesRepository
    ...
    private static upcomingMoviesRepository instance;
        private final MutableLiveData<List<movieModel>> movies;

    public upcomingMoviesRepository() {
    ...
    public static upcomingMoviesRepository getInstance() {
        if (instance == null){
        instance =new upcomingMoviesRepository();
    }
        return instance;
    }
    ...
    private void CallMovieAPI(int page) {
        Call<allMoviesResponse>  allMovies=Servicey.getMovieApi().upcoming(Credentials.API_KEY,page,"en");
